...
dd = read_tsv("E:/Luke/Documents/Cars/C4/fuel_20221216.txt")
dd |> print(n=40)
...
x_limits = as_date(c("2021-01-01","2023-01-01"))
x_breaks = as_date(c("2021-01-01","2021-07-01","2022-01-01","2022-07-01","2023-01-01"))
...
ggexport(figure, filename = "E:/Luke/Documents/Cars/C4/C4_fuel_20221216.png",
